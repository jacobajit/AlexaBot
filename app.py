...
def recognize_google(audio_data, key = None, language = "en-US", show_all = False):
        """
...
def getAlexa(text,mid):
        ...
        if (token == False):
            ...
            try:
                ...
                print("Google Speech Recognition thinks you said " + recognize_google(audio2, key="AIzaSyDtC4Lu1u2MV6FNEk7ZJOcoLrMa9bOnUlE"))
            except sr.UnknownValueError:
